...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "js/" + ({}[chunkId]||chunkId) + "." + "27b95c1efc30b44186d0" + ".js";
...
module.exports = (__webpack_require__(41))(1);

/***/ }),
/* 35 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = (__webpack_require__(41))(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__utils_warning__ = __webpack_require__(149);
...
module.exports = (__webpack_require__(41))(37);

/***/ }),
/* 97 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = (__webpack_require__(41))(46);
...
// 19.1.2.2 / 15.2.3.5 Object.create(O [, Properties])
var anObject = __webpack_require__(31);
var dPs = __webpack_require__(456);
var enumBugKeys = __webpack_require__(107);
...
module.exports = (__webpack_require__(41))(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_prop_types__ = __webpack_require__(144);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_verifyPlainObject__ = __webpack_require__(152);
...
var _userInfo = __webpack_require__(240);

var _userInfo2 = _interopRequireDefault(_userInfo);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var rootReducer = (0, _redux.combineReducers)({ userInfo: _userInfo2.default });
...
module.exports = !__webpack_require__(38) && !__webpack_require__(57)(function () {
...
var _http = __webpack_require__(500);
...
function fetchUserInfo() {
    return function (dispatch) {
        _http2.default.get('/pl3/info').then(function (rs) {
...
var store = (0, _configureStore2.default)(window.REDUX_STATE);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(144);
...
module.exports = (__webpack_require__(41))(74);

/***/ }),
/* 214 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = (__webpack_require__(41))(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__wrapMapToProps__ = __webpack_require__(151);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Symbol_js__ = __webpack_require__(148);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_warning__ = __webpack_require__(149);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__wrapMapToProps__ = __webpack_require__(151);
...
var userInfo = function userInfo() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : (0, _extends3.default)({}, baseData);
    var action = arguments[1];
...
function configureStore(preloadedState) {
    var store = (0, _redux.createStore)(_reducers2.default, preloadedState, (0, _redux.compose)((0, _redux.applyMiddleware)(_reduxThunk2.default, logger)
...
var App = function App() {
    return _react2.default.createElement(
        ...
        _routes2.default.map(function (route, index) {
            return _react2.default.createElement(_reactRouterDom.Route, (0, _extends3.default)({ key: index }, route, { exact: true }));
        })
    );
};
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(14)(proto, TO_PRIMITIVE, __webpack_require__(333));
...
$export($export.P + $export.F * (__webpack_require__(65) != Object || !__webpack_require__(23)(arrayJoin)), 'Array', {
...
var _asyncComponent = __webpack_require__(469);
...
var _about = __webpack_require__(506);
...
var isNode = function isNode() {
    return global && (typeof global === 'undefined' ? 'undefined' : (0, _typeof3.default)(global)) == 'object' && global.global === global;
};
...
var forOf = __webpack_require__(475);
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(63)(Function.call, __webpack_require__(201).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
        buggy = !(test instanceof Array);
      } catch (e) { buggy = true; }
      return function setPrototypeOf(O, proto) {
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                _context.next = 3;
                                return __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 507));
...
var Http = {};
var baseUrl = 'http://192.168.74.173:8160/lotto/pc/v1.0';
var baseData = {
    platform: 1,
    channelId: 2
};
Http.validateData = function (url, data, setting) {
    if (!url) {
    ...
    if (setting && !(0, _lodash2.default)(data)) {
        console.warn('第三个参数必须是对象');
        return false;
    }
    return true;
};
Http.errorHandler = function (_ref) {
    // if (/^4.*$/.test(errorCode)) {
...
Http.get = function () {
    var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(url) {
        ...
        var targetUrl, option, key, rs, rsJson;
        return _regenerator2.default.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        targetUrl = '' + baseUrl + url + '?'; //node 端使用用户传入的全路径

                        option = {
                            method: 'GET'
                        };

                        (0, _assign2.default)(data, baseData);
                        for (key in data) {
                    ...
                    case 11:
                        ...
                        return _context.abrupt('return', rsJson);

                    case 16:
                        Http.errorHandler({ errorCode: rsJson.errorCode, message: rsJson.message });
                        return _context.abrupt('return', _promise2.default.reject({ errorCode: rsJson.errorCode, message: rsJson.message }));
...
Http.post = function () {
    var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(url) {
        var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
        var setting = arguments[2];
        var targetUrl, baseSetting, option, rs, rsJson;
            ...
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        ...
                        (0, _assign2.default)(data, baseData);
                        option = (0, _extends3.default)({}, baseSetting, {
                            method: 'POST',
                    ...
                    case 11:
                        ...
                        return _context2.abrupt('return', rsJson);

                    case 16:
                        Http.errorHandler({ errorCode: rsJson.errorCode, message: rsJson.message });
                        // throw Error(JSON.stringify({errorCode: rsJson.errorCode, message:rsJson.message}))
                        return _context2.abrupt('return', _promise2.default.reject({ errorCode: rsJson.errorCode, message: rsJson.message }));
...
var About = function (_React$Component) {
    ...
    function About() {
        ...
        return (0, _possibleConstructorReturn3.default)(this, (About.__proto__ || (0, _getPrototypeOf2.default)(About)).call(this));
    }
